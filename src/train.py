...
def parse_args(argv=None):
    ...
    parser.add_argument("--cf_influence_weight", type=float, default=None)
    parser.add_argument("--cf_topk", type=int, default=None)
    parser.add_argument("--cf_margin", type=float, default=None)
